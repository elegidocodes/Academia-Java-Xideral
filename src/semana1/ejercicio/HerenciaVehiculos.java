...
class Auto extends Vehiculo {
    ...
    public void arrancar() {
        System.out.println("  El auto " + marca + " " + modelo + " arranca el motor...");
    }
...
class Moto extends Vehiculo {
    ...
    @Override
    public void arrancar() {
        System.out.println("  La moto " + marca + " " + modelo + " ruge con " + cilindrada + "cc...");
    }
...
class VehiculoElectrico extends Auto {
    ...
    @Override
    public void arrancar() {
        System.out.println("  El vehiculo eléctrico " + marca + " " + modelo + " arranca silenciosamente... " + "(autonomía: " + autonomiaKm + " km)");
    }

    // detener() se hereda de Auto sin cambios

    @Override
    public String toString() {
        return info() + " - autonomía " + autonomiaKm + " km";
    }
}
...
public class HerenciaVehiculos {
    static void main(String[] args) {
        ...
        // Contar por tipo — VehiculoElectrico antes que Auto
